...
PROVIDERS: dict = {
    ...
    "nvidia": {
        ...
        "models": {
            ...
            "mistral_small4":       "mistralai/mistral-small-4-119b-2603",
            "palmyra_creative_122b":"writer/palmyra-creative-122b",
            "palmyra_fin_70b":      "writer/palmyra-fin-70b-32k",
            "codestral_22b":        "mistralai/codestral-22b-instruct-v0.1",
            ...
            "qwen3_next_80b_think": "qwen/qwen3-next-80b-a3b-thinking",
            "qwen35_122b":          "qwen/qwen3.5-122b-a10b",
            "glm51":                "z-ai/glm-5.1",
            "glm5":                 "z-ai/glm5",
            "minimax_m25":          "minimaxai/minimax-m2.7",
            "deepseek_flash":       "deepseek-ai/deepseek-v4-flash",
            "deepseek_v3":          "deepseek-ai/deepseek-v4-pro",
            ...
            "stepfun_flash":        "stepfun-ai/step-3.5-flash",
            # ── Vision ────────────────────────────────────────────────────────
            ...
            "riva_translate":       "nvidia/riva-translate-4b-instruct",
            ...
            "ai_video_detector":    "nvidia/ai-synthetic-video-detector",
            "nemotron_reward":      "nvidia/nemotron-4-340b-reward",
    ...
    "venice": {
        ...
        "models": {
            ...
            "gpt_codex_53":           "openai-gpt-53-codex",
            "gpt_oss_120b":           "openai-gpt-oss-120b",
            "gpt54":                  "openai-gpt-54",
            "gpt54_pro":              "openai-gpt-54-pro",
            "qwen_vl_235b":           "qwen3-vl-235b-a22b",
            "qwen3_235b":             "qwen3-235b-a22b-instruct-2507",
            "qwen3_235b_think":       "qwen3-235b-a22b-thinking-2507",
...
TASK_MODELS: dict = {
    ...
    "builder":          ("venice",        "gpt_codex_52"),
    "builder_review":   ("venice",        "gpt_codex_53"),
    ...
    "board_venice":     ("venice",       "venice_uncensored_12"),
...
BOARD_MEMBERS = [
    {"key": "board_strategy",     "name": "STRATEGY",     "alias": "Kimmy",    "role": "Strategic Advisor"},
    {"key": "board_finance",      "name": "FINANCE",      "alias": "Rich Max",  "role": "Finance & Risk Analyst"},
    {"key": "board_creative",     "name": "CREATIVE",     "alias": "Palmyra",   "role": "Creative Director"},
    {"key": "board_tech",         "name": "TECH",         "alias": "Linnerd",   "role": "Tech Lead"},
    {"key": "board_ops",          "name": "OPS",          "alias": None,        "role": "Operations"},
    {"key": "board_distribution", "name": "DISTRIBUTION", "alias": "OSID",      "role": "Distribution & Growth"},
    {"key": "shadow_chat",        "name": "SHADOW",       "alias": "Shadow",    "role": "Dark Authority"},
    {"key": "board_dolphin",      "name": "GEMMA",        "alias": "Gemma",     "role": "Uncensored Voice"},
...
BRAINSTORM_MEMBERS = [
    ...
    {"key": "capi",                "name": "CAPI",      "alias": None},
    {"key": "board_venice_llama",  "name": "VENICE70",  "alias": "Vince"},
    {"key": "brainstorm_glm",      "name": "GLM",       "alias": "Glenda"},
    {"key": "brainstorm_kimi",     "name": "STRATEGY",  "alias": "Kimmy"},
    {"key": "brainstorm_mistral",  "name": "FINANCE",   "alias": "Rich Max"},
    {"key": "brainstorm_minimax",  "name": "MINIMAX",   "alias": "Max"},
    {"key": "brainstorm_qwq",      "name": "QWQ",       "alias": "Quincy"},
]
